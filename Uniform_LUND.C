...
void Uniform_LUND(TString inputFile = "", TString outputFile = "", int nFiles = 800, string target = "liquid", int A = 1, int Z = 1)
{
  ...
  TString lundPath = "./lundfiles"; // C12x4_G18_02a_00_000_Q204_598636MeV
